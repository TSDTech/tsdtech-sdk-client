      ...
      child: Align(
        ...
        child: Padding(
          padding: isMobile
              ...
              : const EdgeInsets.only(top: 88, right: 24),
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: Colors.black.withValues(alpha: 0.12), blurRadius: 18)
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const DsText(
            text: 'Seu carrinho está vazio', variant: DsTextVariant.baseBold),
        const SizedBox(height: 8),
        const DsText(
            text: 'Adicione serviços do catálogo para começar.',
