...
void showConfirmProviderRequestModal(
  ...
  try {
    providerRequest = providerRequestStore.providerRequests
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const DsText(
                    text: 'Confirmar envio do pedido ao provedor?',
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            DsText(
                                text: providerRequest?.service?.name ?? '-',
                                variant: DsTextVariant.baseBold),
                            const SizedBox(height: 4),
                            DsText(
                                text:
                                    'Pedido nº: ${providerRequest?.id ?? providerRequestId}',
                            ...
                            Row(
                              children: [
                                ...
                                DsText(
                                    text:
                                        'Serviço: ${providerRequest?.service?.name ?? serviceId}',
                                    variant: DsTextVariant.small),
                              ],
                            ),
                          ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            DsText(
                                text:
                                    'Após o envio, o provedor será notificado. Acompanhe o status na lista de pedidos.',
                                variant: DsTextVariant.small,
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (onConfirm != null) {
                            ...
                            if (!success) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        'Erro ao enviar pedido ao provedor. Tente novamente.')),
                              );
                              return;
                            }
                          }
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text(
                                    'Pedido enviado ao provedor com sucesso.')),
                          );
                        },
