...
class VehicleOnboardingPrefs {
  ...
  static bool get() {
    return SharedPrefsHelper.prefs.getBool(_vehicleOnboardingCompletedKey) ?? false;
  }

  static Future<void> set(bool completed) async {
    await SharedPrefsHelper.prefs.setBool(_vehicleOnboardingCompletedKey, completed);
  }
}
