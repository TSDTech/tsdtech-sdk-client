    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: selected ? const Color(0xFFD6E9FF) : const Color(0xFFE6E9EE)),
          borderRadius: BorderRadius.circular(20),
          boxShadow: selected
              ? [BoxShadow(color: const Color.fromRGBO(11, 102, 255, 0.06), blurRadius: 6, offset: const Offset(0, 2))]
              : null,
        ),
        child: DsText(
          text: label,
