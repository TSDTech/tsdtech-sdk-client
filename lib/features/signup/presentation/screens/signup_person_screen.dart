...
class SignupPersonScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> submit() async {
      ...
      try {
        final ValueResult result =
            await AuthServiceClientUser.instance.signup(dto);
        overlay.remove();
        ...
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text(vr.error), backgroundColor: Colors.redAccent));
        }
      }
    }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: DsTextfield(
                              controller: store.cellphoneController,
                              hintText: 'Celular')),
                    ],
                  ),
                  const SizedBox(height: 12),
