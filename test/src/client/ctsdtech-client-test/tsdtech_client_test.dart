...
void main() {
  test('TsdtechClient does not initialize GatewayService when gatewayBaseUrl is null', () {
    final client = TsdtechClient();
    expect(client.gateway, isNull);
  });

  test('TsdtechClient initializes GatewayService when gatewayBaseUrl is provided', () {
    final client = TsdtechClient(
