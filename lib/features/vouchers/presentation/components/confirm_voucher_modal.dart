          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const DsText(
                    text: 'Confirmar emissão da 2ª via?',
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            DsText(
                                text: 'Data/horário: $formattedDate',
                                variant: DsTextVariant.small),
                            const SizedBox(height: 4),
                            Row(
                              children: [
                                ...
                                DsText(
                                    text:
                                        'Validade: ${voucher.service?.validTimestamp ?? '-'}',
                                    variant: DsTextVariant.small),
                              ],
                            ),
                          ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            DsText(
                                text:
                                    'Atenção: após a emissão não será possível cancelar ou solicitar reembolso.',
                                variant: DsTextVariant.small,
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: const DsText(
                            text: 'Voltar', variant: DsTextVariant.baseBold),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (payload != null) {
                            final submitResult = await ServicesService.instance
                                .submitServiceForm(
                              payload,
                          ...
                          final providerRequestStore =
                              GetIt.instance<ProviderRequestStore>();
                          providerRequestStore.providerRequests
                              .add(ProviderRequest(
                            id: DateTime.now()
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text(
                                    'Emissão confirmada! Voucher agendado.')),
                          );
                        },
